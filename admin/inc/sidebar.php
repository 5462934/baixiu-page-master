...
<div class="aside">
  <div class="profile">
    ...
    <h3 class="name"><?php echo $users['nickname'];?></h3>
  </div>
  <ul class="nav">
    ...
    <?php $is_set_page = in_array($current_page, array('nav-menus','slides', 'settings')) ?>
    <li<?php echo $is_set_page ? ' class="active"' : ''; ?>>
      <a href="#menu-settings" class="collapsed" data-toggle="collapse">
        <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
      </a>
      <ul id="menu-settings" class="collapse<?php echo $is_set_page ? ' in' : '' ?>">
        <li<?php echo $current_page === 'nav-meanus' ? ' class = "active"' : '';   ?>><a href="nav-menus.php">导航菜单</a></li>
